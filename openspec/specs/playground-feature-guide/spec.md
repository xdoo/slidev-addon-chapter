...
Define the beginner-friendly, executable Slidev playground guide that explains the addon through paired live results, copyable Markdown, and CSS customization examples.
